...
public class planeetUranus extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_uranus);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetUranus_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetUranus_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetUranus_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetUranus_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetUranus_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetUranus_weetjesFragment();
                break;
        }
