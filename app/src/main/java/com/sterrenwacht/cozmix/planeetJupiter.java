...
public class planeetJupiter extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_jupiter);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetJupiter_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetJupiter_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetJupiter_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetJupiter_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetJupiter_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetJupiter_weetjesFragment();
                break;
        }
