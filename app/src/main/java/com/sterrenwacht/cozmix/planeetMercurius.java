...
public class planeetMercurius extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_mercurius);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetMercurius_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetMercurius_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetMercurius_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetMercurius_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetMercurius_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetMercurius_weetjesFragment();
                break;
        }
