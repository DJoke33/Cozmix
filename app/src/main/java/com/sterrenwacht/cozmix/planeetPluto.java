...
public class planeetPluto extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_pluto);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetPluto_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetPluto_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetPluto_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetPluto_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetPluto_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetPluto_weetjesFragment();
                break;
        }
