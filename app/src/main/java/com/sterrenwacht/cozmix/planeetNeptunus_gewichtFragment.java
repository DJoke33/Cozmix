...
public class planeetNeptunus_gewichtFragment extends Fragment implements View.OnFocusChangeListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_neptunus_gewicht, null);
        ...
        btnBereken.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valueGewichtP1.matches("")) {
                    ...
                    double gewichtResultaatP1 = gewichtP1 * 1.12;
                ...
                if (valueGewichtP2.matches("")) {
                    ...
                    double gewichtResultaatP2 = gewichtP2 * 1.12;
                ...
                if (valueGewichtP3.matches("")) {
                    ...
                    double gewichtResultaatP3 = gewichtP3 * 1.12;
                ...
                if (valueGewichtP4.matches("")) {
                    ...
                    double gewichtResultaatP4 = gewichtP4 * 1.12;
