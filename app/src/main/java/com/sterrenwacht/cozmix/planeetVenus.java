...
public class planeetVenus extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_venus);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetVenus_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetVenus_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetVenus_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetVenus_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetVenus_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetVenus_weetjesFragment();
                break;
        }
