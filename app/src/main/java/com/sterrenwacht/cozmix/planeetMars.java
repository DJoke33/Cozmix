...
public class planeetMars extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_mars);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetMars_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetMars_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetMars_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetMars_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetMars_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetMars_weetjesFragment();
                break;
        }
