...
public class planeetPlanetoiden extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_planetoiden);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetPlanetoiden_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetPlanetoiden_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetPlanetoiden_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetPlanetoiden_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetPlanetoiden_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetPlanetoiden_weetjesFragment();
                break;
        }
