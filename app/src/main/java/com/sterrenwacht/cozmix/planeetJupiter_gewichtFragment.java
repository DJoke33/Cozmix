...
public class planeetJupiter_gewichtFragment extends Fragment implements View.OnFocusChangeListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_jupiter_gewicht, null);
        ...
        btnBereken.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valueGewichtP1.matches("")) {
                    ...
                    double gewichtResultaatP1 = gewichtP1 * 2.34;
                ...
                if (valueGewichtP2.matches("")) {
                    ...
                    double gewichtResultaatP2 = gewichtP2 * 2.34;
                ...
                if (valueGewichtP3.matches("")) {
                    ...
                    double gewichtResultaatP3 = gewichtP3 * 2.34;
                ...
                if (valueGewichtP4.matches("")) {
                    ...
                    double gewichtResultaatP4 = gewichtP4 * 2.34;
