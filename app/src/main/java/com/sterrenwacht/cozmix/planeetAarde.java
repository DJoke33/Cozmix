...
public class planeetAarde extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadFragment(new planeetAarde_homeFragment());
    ...
    private boolean LoadFragment(Fragment fragment){
        ...
        if (fragment != null){
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.planeetAarde_fragment_container, fragment)
                    .commit();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            ...
            case R.id.navigation_algemeen_plan:
                fragment = new planeetAarde_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetAarde_algemeenStandFragment();
                break;
