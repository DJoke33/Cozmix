...
public class planeetSaturnus extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planeet_saturnus);

        BottomNavigationView navigation = findViewById(R.id.navigationPluto);
        navigation.setOnNavigationItemSelectedListener(this);
        LoadFragment(new planeetSaturnus_homeFragment());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.navigation_home:
                fragment = new planeetSaturnus_homeFragment();
                break;
            case R.id.navigation_zwaarte:
                fragment = new planeetSaturnus_gewichtFragment();
                break;
            case R.id.navigation_algemeen_plan:
                fragment = new planeetSaturnus_algemeenPlanFragment();
                break;
            case R.id.navigation_algemeen_stand:
                fragment = new planeetSaturnus_algemeenStandFragment();
                break;
            case R.id.navigation_weetjes:
                fragment = new planeetSaturnus_weetjesFragment();
                break;
        }
